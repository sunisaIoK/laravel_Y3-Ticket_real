...
<body>
            ...
            <div class="rightside">
                <form action="{{ route('order.order') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="price">
                        <p>User Name</p>
                        <div class="">
                            <h5 style="margin-top: 8%">{{ $Username->name }}</h5>
                        ...
                        <p id="price">
                            <input type="text" name="price" id="price" class="inputbox" placeholder=""
                                readonly>
                            <span class="text-danger">
                                @error('price')
                                    {{ $message }}
    ...
    <div class="bill">
            <div class="leftside">
                <img src="{{ url('image/' . $concert->imagemap) }}" alt="Concert Image">
            </div>
        </div>
